...

{
  ...
  "dataset_reader": {
    "type": "copynet_math2tree_mathxling_disallow_pow",
    'source_tokenizer': {
      "type": "spacy",
      "pos_tags": POS_TAGS,
  ...
  "train_data_path": dataset_path + "Math23K/train.json.jsonl;" + dataset_path + "MathQA/train.json.disallow_pow.jsonl",
  "validation_data_path": dataset_path + "Math23K/dev.json.jsonl;" + dataset_path + "MathQA/dev.json.disallow_pow.jsonl",
  "model": {
